...
public class RenameTableModel implements TableModel {
	 ...
	 *            the audio files
	 */
	public RenameTableModel(List<RenameAudioFile> audioFiles) {
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		if (columnIndex == 0)
			return this.audioFiles.get(rowIndex).getCurrentName();
		else
			return this.audioFiles.get(rowIndex).getNewName();
	}
